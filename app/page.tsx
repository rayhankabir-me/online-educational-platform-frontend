...
export default function Home() {
  return (
    ...
    <a href="/posts" className="text-blue-700 border border-blue-700 hover:bg-blue-100 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:border-blue-600 dark:hover:bg-blue-100 focus:outline-none dark:focus:ring-blue-800">Posts</a>
